...
WELCOME_TEXT = (
    "🏠 <b>Ты нашёл «Милый дом»!</b> 🎉\n\n"
    "Тут живут:\n"
    "🎧 <b>Поддержка</b> — когда грустно, тревожно или просто надо выговориться\n"
    "💬 <b>Общение</b> — когда хочется поболтать и найти друзей\n"
    "🎭 <b>Ролка</b> — когда хочется отыграть другого себя\n\n"
    "🕶 <b>Всё анонимно.</b> Никто не узнает, кто ты. Даже админ.\n\n"
    "✉️ Просто напиши <b>«Привет»</b> — и с тобой свяжется первый свободный администратор.\n\n"
    "🔁 Не зашёл админ? Напиши:\n"
    "<b>«Хочу другого админа»</b> — и мы подберём нового.\n\n"
    "🏡 Дом всегда открыт. Заходи, располагайся ❤️\n\n"
